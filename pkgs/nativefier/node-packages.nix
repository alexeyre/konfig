...
let
  sources = {
    ...
    "@types/electron-packager-14.0.0" = {
      ...
      version = "14.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/electron-packager/-/electron-packager-14.0.0.tgz";
        sha512 = "n47/AbT4DEYPyXtES2myPyKCxVE3hICAB3MnpoVg+Ba8CLBGOpUUsNJ5fyLhfKt5N06sT9nTk4eAc+rtYVpvTQ==";
      };
    };
    "@types/events-3.0.0" = {
    ...
    "@types/ncp-2.0.3" = {
      ...
      version = "2.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/ncp/-/ncp-2.0.3.tgz";
        sha512 = "eZatZMWhPHUHY/1hUUqwGrWzBAE9deYR3L0QJMicpVkBUOrQslhWblw5Ye+rKuzvFG/UQ3jDolMcjhC2WKUQ5w==";
      };
    };
    "@types/node-8.10.60" = {
    ...
    "@types/page-icon-0.3.2" = {
      ...
      version = "0.3.2";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/page-icon/-/page-icon-0.3.2.tgz";
        sha1 = "d5317710f8d12a27b161a90cdba8f1a4149cc113";
      };
    };
    "@types/shelljs-0.8.7" = {
      ...
      version = "0.8.7";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/shelljs/-/shelljs-0.8.7.tgz";
        sha512 = "Mg2qGjLIJIieeJ1/NjswAOY9qXDShLeh6JwpD1NZsvUvI0hxdUCNDpnBXv9YQeugKi2EHU+BqkbUE4jpY4GKmQ==";
      };
    };
    "@types/tmp-0.2.0" = {
    ...
    "cross-zip-3.0.0" = {
      ...
      version = "3.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/cross-zip/-/cross-zip-3.0.0.tgz";
        sha512 = "cm+l8PJ6WiSQmKZ/x8DGvUm2u/3FX2JFs1AFd18gdHaVhP5Lf4oE6Jrj2Jd05JYSioz5x+nIRVp0zBQuzuCRcQ==";
      };
    };
    "css-select-1.2.0" = {
      name = "css-select";
    ...
    "electron-osx-sign-0.4.15" = {
      ...
      version = "0.4.15";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-osx-sign/-/electron-osx-sign-0.4.15.tgz";
        sha512 = "1QtPNpjIji9bGZ0VRFwtJUyU1uHi7q3XUAOG0qFsvAUfs5H0T8hbgUfyg3xvPzmF1ruV8T8pQmQ86vNfLrcRiA==";
      };
    };
    "electron-packager-14.2.1" = {
      ...
      version = "14.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-packager/-/electron-packager-14.2.1.tgz";
        sha512 = "g6y3BVrAOz/iavKD+VMFbehrQcwCWuA3CZvVbmmbQuCfegGA1ytwWn0BNIDDrEdbuz31Fti7mnNHhb5L+3Wq9A==";
      };
    };
    "encodeurl-1.0.2" = {
      name = "encodeurl";
    ...
    "rcedit-2.1.1" = {
      ...
      version = "2.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/rcedit/-/rcedit-2.1.1.tgz";
        sha512 = "N1JyXxHD2zpqqW4A77RNK1d/M+tyed9JkvL/lnUI5cf4igF/8B9FNLFCtDUhGrk2GWEPxC+RF0WXWWB3I8QC7w==";
      };
    };
    "read-pkg-2.0.0" = {
      name = "read-pkg";
...
in
{
  nativefier = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "pc/xqmK4Ez1GmwPe5oDBrgm7x5SXNahKjNKpZWFFPq1vsm2ORJkJfIpbmyGHVPFU79o2QUFdAClZaTkAG36FrQ==";
    };
    dependencies = [
      ...
      sources."@types/ncp-2.0.3"
      sources."@types/node-8.10.60"
      sources."@types/page-icon-0.3.2"
      sources."@types/shelljs-0.8.7"
      ...
      (sources."electron-osx-sign-0.4.15" // {
        dependencies = [
          sources."debug-2.6.9"
          sources."ms-2.0.0"
        ];
      ...
      (sources."electron-packager-14.2.1" // {
        dependencies = [
          sources."electron-notarize-0.2.1"
