  ...
  programs.newsboat = {
    ...
    urls = [
      # { tags = ["youtube"]; url = "https://www.youtube.com/feeds/videos.xml?channel_id=
      {
        tags = [ "youtube" ];
        url =
          "https://www.youtube.com/feeds/videos.xml?channel_id=UCBr_Fu6q9iHYQCh13jmpbrg";
      } # Errichto
      {
        tags = [ "youtube" ];
        url =
      ...
      } # some scottish man
      {
        tags = [ "youtube" ];
        url =
          "https://www.youtube.com/feeds/videos.xml?channel_id=UCKuDLsO0Wwef53qdHPjbU2Q";
      } # William Lin
      {
        tags = [ "youtube" ];
        url =
      ...
      } # 3blue1brown
      {
        tags = [ "youtube" ];
        url =
          "https://www.youtube.com/feeds/videos.xml?channel_id=UC52kszkc08-acFOuogFl5jw";
      } # tibees
      ...
      {
        tags = [ "twitter" ];
        url = "https://twitrss.me/twitter_user_to_rss/?user=tferriss";
      } # tim ferriss
    ];
  };
}
