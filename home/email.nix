{ pkgs, ... }: {
  ...
  accounts.email.accounts.edinburgh = {
    ...
    primary = true;
    passwordCommand = let gopass = "${pkgs.gopass}/bin/gopass";
    in ''${gopass} show -o "websites/www.ed.ac.uk/s2031787@ed.ac.uk"'';
  };
  ...
  accounts.email.accounts.alexeeyre = {
    ...
    passwordCommand = let gopass = "${pkgs.gopass}/bin/gopass";
    in ''${gopass} show -o "websites/gmail.com/alexeeyre@gmail.com"'';
  };
